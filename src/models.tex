...
\begin{defn}[one-way finite automata]
	...
	The deterministic version of 1NFA is denoted 1DFA, or simply DFA.
\end{defn}
...
\begin{defn}[two-way finite automata]
	...
	The deterministic version of 2NFA is denoted 2DFA.
\end{defn}
...
\begin{defn}[limited automata]
	...
	\end{itemize}
	The initial configuration is the same as for 2NFAs.
	...
	\noindent The deterministic version of $k$-LA is denoted $k$-DLA.
\end{defn}
