...
Note that this is only possible on \NFAs, since the removal of multiple starting states from a \DFA can imply an exponential growth in the number of states \cite{HolSal+01}.
