...
% TODO: present right away the simulation for the version with end-markers
\subsection{2DFAs}
...
% TODO: use newly designed structure
...
% TODO: switch to new structure: merge this with 2DFA without end-markers, giving only one simulation
