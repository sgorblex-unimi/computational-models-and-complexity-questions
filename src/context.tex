...
\citeauthor{RabSco59} proved that these new models also characterize regular languages, by providing a simulation of them by \ONFAs. The simulation is based on \emph{crossing sequences} (more in \Cref{sec:crossseq2DFA})~\cite{RabSco59}.
