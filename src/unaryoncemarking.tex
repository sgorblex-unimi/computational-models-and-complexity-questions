...
In \Cref{sec:oncemarking-general}, we revise the previous work on once-marking $1$-limited automata, proving a lower bound for the simulation by \ONFA.
...
This concept is inspired by the simulation of unary \TNFA by \ODFA presented by \doublecite{MerPig01}.
...
Ideally, a polynomial simulation of \OMOLA by \TDFA would solve the "hard" variants of the Sakoda and Sipser problem in this realm (green in \Cref{tab:sims-om-unary-oncemarking}), and may also bring the open problems on one-way machines to subexponential, depending on the specific function.
