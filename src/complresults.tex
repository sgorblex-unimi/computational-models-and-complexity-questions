...
\begin{itemize}
	...
	\item The cells highlighted in \hlG{green} consist in a harder version of the problem, with an extension of nondeterministic finite automata, namely \OLAs, as the simulated machine.
\end{itemize}
