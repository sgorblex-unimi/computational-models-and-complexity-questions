...
\begin{itemize}
	...
	\item $\ge\exp$: since the unary witness language $\set{a^{2^n}}\star$ is recognized by the linear size \ODLA presented by \triplecite{PigPri19}, but cannot be recognised by a \TNFA with less than $\Cexp$ states, as proven by \triplecite{MerPig00}.
\end{itemize}
